...
$(function() {
	...
	if (document.querySelector('.noUiSlider')) {
		const slider = document.querySelector('.noUiSlider'),
			  marginMax = document.querySelector('#slider-range--max'),
		      marginMin = document.querySelector('#slider-range--min'),
		      // Min Max prices
			  minSlider = 140,
			  maxSlider = 620
		...
		// Set to the input fields

		marginMin.addEventListener('change', function () {
			slider.noUiSlider.set(marginMin.value, null)
		})

		marginMax.addEventListener('change', function () {
			slider.noUiSlider.set([null ,marginMax.value])
		})
	}
